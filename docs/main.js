...
(() => {
  ...
  var monoidReaderT = function(dictApplicative) {
    var pure17 = pure(applicativeReaderT(dictApplicative));
    ...
    return function(dictMonoid) {
      ...
      return {
        mempty: pure17(mempty(dictMonoid)),
        Semigroup0: function() {
  ...
  var prettyArray = function(dictPretty) {
    ...
    return {
      pretty: function(v) {
        ...
        ;
        return intercalate4(", ")(map11(pretty13)(v));
      }
    };
  };
  var prettyList = function(dictPretty) {
    ...
    return {
      pretty: function(v) {
        ...
        ;
        return intercalate1(", ")(map12(pretty13)(v));
      }
    };
  };
  ...
  var genericEqSum2 = /* @__PURE__ */ genericEqSum(/* @__PURE__ */ genericEqConstructor(genericEqNoArguments));
  ...
  var prettyLat = {
    pretty: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 161, column 1 - line 166, column 59): " + [v.constructor.name]);
    }
  };
  var prettyDataTerm = {
    pretty: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 115, column 1 - line 118, column 30): " + [v.constructor.name]);
    }
  };
  ...
  var prettyTerm = {
    pretty: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 94, column 1 - line 97, column 65): " + [v.constructor.name]);
    }
  };
  ...
  var prettyProp = {
    pretty: function(v) {
      return pretty2(v.value0) + (" " + parens(pretty5(v.value1)));
    }
  };
  ...
  var prettyHyp = {
    pretty: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 216, column 1 - line 219, column 41): " + [v.constructor.name]);
    }
  };
  ...
  var genericTerm_ = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 89, column 1 - line 89, column 31): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var genericEq2 = /* @__PURE__ */ genericEq(genericName_)(/* @__PURE__ */ genericEqConstructor(/* @__PURE__ */ genericEqArgument(eqString)));
  ...
  var genericDataTerm_ = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 110, column 1 - line 110, column 35): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var genericEq4 = /* @__PURE__ */ genericEq(genericDataTerm_)(/* @__PURE__ */ genericEqSum2(/* @__PURE__ */ genericEqSum(/* @__PURE__ */ genericEqConstructor(/* @__PURE__ */ genericEqArgument(eqBoolean)))(/* @__PURE__ */ genericEqConstructor(/* @__PURE__ */ genericEqArgument(eqInt)))));
  var eqName = {
    eq: function(x) {
      return function(y) {
        return genericEq2(x)(y);
      };
    }
  };
  var genericEqArgument2 = /* @__PURE__ */ genericEqArgument(eqName);
  var genericEqConstructor2 = /* @__PURE__ */ genericEqConstructor(genericEqArgument2);
  var genericEq5 = /* @__PURE__ */ genericEq(genericRel_)(genericEqConstructor2);
  var genericEqSum1 = /* @__PURE__ */ genericEqSum(genericEqConstructor2);
  var eqRel = {
    eq: function(x) {
      return function(y) {
  ...
  var names_in_Term = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Foliage.Grammar (line 250, column 1 - line 250, column 34): " + [v.constructor.name]);
  };
  var defs_of_Prog = function(v) {
    var go2 = function(v1) {
      if (v1 instanceof DefRel) {
        return set(function() {
          var $610 = at2(v1.value0)(strongFn);
          return function($611) {
            return prop5($610($611));
          };
        }())(pure3(v1.value1));
      }
      ;
      if (v1 instanceof DefRule) {
        return set(function() {
          var $612 = at2(v1.value0)(strongFn);
          return function($613) {
            return prop1($612($613));
          };
        }())(pure3(v1.value1));
      }
      ;
      if (v1 instanceof DefFun) {
        return set(function() {
          var $614 = at2(v1.value0)(strongFn);
          return function($615) {
            return prop22($614($615));
          };
        }())(pure3(v1.value3));
      }
      ;
      throw new Error("Failed pattern match at Foliage.Grammar (line 266, column 3 - line 266, column 55): " + [v1.constructor.name]);
    };
    return foldr3(go2)({
      relLats: empty5,
      rules: empty5,
  ...
  var prog = /* @__PURE__ */ function() {
    return fromFoldable3([new DefRel("P", IntLat.value), new DefRule("P1", {
      hyps: fromFoldable3([]),
      prop: new Prop("P", new DataTerm(new IntTerm(0)))
    }), new DefRule("P2", {
      hyps: fromFoldable3([new PropHyp(new Prop("P", new DataTerm(new IntTerm(0))))]),
      prop: new Prop("P", new DataTerm(new IntTerm(1)))
    }), new DefRel("Q", IntLat.value), new DefRule("R1", {
      hyps: fromFoldable3([new PropHyp(new Prop("P", new DataTerm(new IntTerm(1))))]),
      ...
      if (v.length === 1 && (v[0] instanceof DataTerm && v[0].value0 instanceof IntTerm)) {
        return pure4(new DataTerm(new IntTerm(v[0].value0.value0 + 1 | 0)));
      }
      ;
      return throwError2("invalid args");
    }), new DefRule("R2", {
      hyps: fromFoldable3([new PropHyp(new Prop("Q", new VarTerm("x"))), new CompHyp("x'", new Invoke("Suc", [new VarTerm("x")]))]),
    ...
    var render = function(state3) {
      return div2([css(discard1(tell2(["flex-grow: 0", "flex-shrink: 1", "width: 50%"]))(function() {
        ...
        return function(html2) {
          return [new Tuple(show4(i2), div2([css(tell2(["flex-shrink: 0", "padding: 0.5em", "border: 0.1em solid black"]))])([fromPlainHTML(html2)]))];
        };
      })(state3.messages))]);
    };
  ...
  var insert8 = /* @__PURE__ */ insert2(ordName);
  ...
  var trace = function(dictMonadAff) {
    ...
    var bind7 = bind(bindReaderT(bindStateT(monadExceptT2)));
    ...
    return function(msg) {
      return bind7(ask3)(function(ctx) {
  ...
  var subst_Term = function(dictMonadAff) {
    var Monad0 = dictMonadAff.MonadEffect0().Monad0();
    var monadExceptT2 = monadExceptT(Monad0);
    var bind7 = bind(bindReaderT(bindReaderT(bindStateT(monadExceptT2))));
    var ask3 = ask(monadAskReaderT(monadReaderT(monadStateT(monadExceptT2))));
    var pure17 = pure(applicativeReaderT(applicativeReaderT(applicativeStateT(monadExceptT2))));
    var apply2 = apply(applyReaderT(applyReaderT(applyStateT(monadExceptT2))));
    var map29 = map(functorReaderT(functorReaderT(functorStateT(functorExceptT(Monad0.Bind1().Apply0().Functor0())))));
    return function(v) {
      if (v instanceof VarTerm) {
        return bind7(ask3)(function(v1) {
          return pure17(fromMaybe(v)(lookup7(v.value0)(v1.sigma)));
        });
      }
      ;
      if (v instanceof DataTerm && v.value0 instanceof UnitTerm) {
        return pure17(new DataTerm(UnitTerm.value));
      }
      ;
      if (v instanceof DataTerm && v.value0 instanceof BoolTerm) {
        return pure17(new DataTerm(new BoolTerm(v.value0.value0)));
      }
      ;
      if (v instanceof DataTerm && v.value0 instanceof IntTerm) {
        return pure17(new DataTerm(new IntTerm(v.value0.value0)));
      }
      ;
      if (v instanceof PairTerm) {
        return apply2(map29(PairTerm.create)(subst_Term(dictMonadAff)(v.value0)))(subst_Term(dictMonadAff)(v.value1));
      }
      ;
      throw new Error("Failed pattern match at Foliage.Engine (line 226, column 1 - line 226, column 60): " + [v.constructor.name]);
    };
  };
  var subst_Prop = function(dictMonadAff) {
    var map29 = map(functorReaderT(functorReaderT(functorStateT(functorExceptT(dictMonadAff.MonadEffect0().Monad0().Bind1().Apply0().Functor0())))));
    var subst_Term1 = subst_Term(dictMonadAff);
    return function(v) {
      return map29(Prop.create(v.value0))(subst_Term1(v.value1));
    };
  };
  var subst_Comp = function(dictMonadAff) {
    ...
    var subst_Term1 = subst_Term(dictMonadAff);
    return function(v) {
      return map29(Invoke.create(v.value0))(traverse22(subst_Term1)(v.value1));
    };
  };
  var subst_Hyp = function(dictMonadAff) {
    ...
    return function(v) {
      if (v instanceof PropHyp) {
        return map29(PropHyp.create)(subst_Prop1(v.value0));
      }
      ;
      if (v instanceof CompHyp) {
        return map29(CompHyp.create(v.value0))(subst_Comp1(v.value1));
      }
      ;
      if (v instanceof CondHyp) {
        return map29(CondHyp.create)(subst_Term1(v.value0));
      }
      ;
      throw new Error("Failed pattern match at Foliage.Engine (line 215, column 1 - line 215, column 57): " + [v.constructor.name]);
    };
  };
  var subst_Rule = function(dictMonadAff) {
    ...
    var subst_Prop1 = subst_Prop(dictMonadAff);
    var pure17 = pure(applicativeReaderT3);
    return function(v) {
      return bind7(traverse22(subst_Hyp1)(v.hyps))(function(hyps) {
        return bind7(subst_Prop1(v.prop))(function(prop8) {
          return pure17({
            hyps,
            prop: prop8
          });
  ...
  var solveSysForSubst = function(dictMonadAff) {
    ...
    var pure17 = pure(applicativeMaybeT2);
    var bindMaybeT2 = bindMaybeT(monadReaderT2);
    var bind7 = bind(bindMaybeT2);
    ...
    var init3 = function(v) {
      return function(v1) {
        ...
        if (v1 instanceof Cons) {
          ...
          ;
          if (v2 instanceof Just) {
            return bind7(lift43(runMaybeT(unify_Term1(v1.value0.value1)(v2.value0))))(function(v3) {
              if (v3 instanceof Nothing) {
                return empty1;
              }
              ;
              if (v3 instanceof Just) {
                return bind7(lift43(flip(runReaderT)({
                  sigma: v3.value0
                })(subst_Term1(v1.value0.value1))))(function(a$prime$prime) {
                  return init3(insert8(v1.value0.value0)(a$prime$prime)(v))(append5(v1.value1)(toUnfoldable5(v3.value0)));
                });
              }
              ;
              throw new Error("Failed pattern match at Foliage.Engine (line 306, column 46 - line 310, column 75): " + [v3.constructor.name]);
            });
          }
          ;
          throw new Error("Failed pattern match at Foliage.Engine (line 298, column 33 - line 310, column 75): " + [v2.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Foliage.Engine (line 296, column 3 - line 296, column 34): " + [v.constructor.name, v1.constructor.name]);
      };
    };
    var go2 = function(sigma) {
      return bind7(traverseWithIndex1(function(x) {
        return function(a2) {
        ...
        var $469 = notEq2(sigma)(sigma$prime);
        if ($469) {
  ...
  var set_props = function(dictMonadAff) {
    ...
    var bind7 = bind(bindReaderT3);
    var monadStateT2 = monadStateT(monadExceptT2);
    var ask3 = ask(monadAskReaderT(monadStateT2));
    var lift43 = lift6(monadStateT2);
    var lift53 = lift12(monadExceptT2);
    var lift62 = lift22(Monad0);
    var pure17 = pure(applicativeReaderT(applicativeStateT(monadExceptT2)));
    return function(props) {
  ...
  var runComp = function(dictMonadAff) {
    ...
    var pure17 = pure(applicativeReaderT(applicativeStateT(monadExceptT2)));
    var throwError4 = throwError(monadThrowReaderT(monadThrowStateT(monadThrowExceptT(Monad0))));
    return function(v) {
      return bind7(ask3)(function(ctx) {
        return bind7(flip(maybe)(pure17)(throwError4([text("runComp"), text("unknown fun name: " + pretty3(v.value0))]))(lookup7(v.value0)(ctx.funs)))(function(f) {
          return flip(either)(pure17)(function(err) {
            return throwError4([text("runComp"), text("fun: " + pretty3(v.value0)), text("err = " + err)]);
          })(f(v.value1));
        });
      });
    };
  ...
  var latCompare_Term = function(dictMonadAff) {
    ...
    var discard14 = discard3(bindWriterT1);
    var tell7 = tell(monadTellWriterT2(monadReaderT(monadStateT(monadExceptT2))));
    var pure17 = pure(applicativeWriterT2(applicativeReaderT(applicativeStateT(monadExceptT2))));
    var bind7 = bind(bindWriterT1);
    var throwError4 = throwError(monadThrowWriterT2(monadThrowReaderT(monadThrowStateT(monadThrowExceptT(Monad0)))));
    return function(v) {
      return function(v1) {
        return function(v2) {
          if (v1 instanceof VarTerm && v2 instanceof VarTerm) {
            return discard14(tell7(pure8(new Tuple(v1.value0, new VarTerm(v2.value0)))))(function() {
              return pure17(new Just(EQ.value));
            });
          }
          ;
          if (v1 instanceof VarTerm) {
            return discard14(tell7(pure8(new Tuple(v1.value0, v2))))(function() {
              return pure17(new Just(GT.value));
            });
          }
          ;
          if (v2 instanceof VarTerm) {
            return discard14(tell7(pure8(new Tuple(v2.value0, v1))))(function() {
              return pure17(new Just(LT.value));
            });
          }
          ;
          if (v instanceof UnitLat) {
          ...
          if (v instanceof IntLat && (v1 instanceof DataTerm && (v1.value0 instanceof IntTerm && (v2 instanceof DataTerm && v2.value0 instanceof IntTerm)))) {
            return pure17(new Just(compare2(v1.value0.value0)(v2.value0.value0)));
          }
          ;
          if (v instanceof DiscreteLat) {
            return bind7(latCompare_Term(dictMonadAff)(v.value0)(v1)(v2))(function(v3) {
          ...
          if (v instanceof OppositeLat) {
            return bind7(latCompare_Term(dictMonadAff)(v.value0)(v1)(v2))(function(v3) {
              ...
              ;
              if (v3 instanceof Just) {
                return pure17(new Just(invert(v3.value0)));
              }
              ;
              throw new Error("Failed pattern match at Foliage.Engine (line 280, column 31 - line 282, column 37): " + [v3.constructor.name]);
            });
          }
          ;
          return throwError4([text("latCompare_Term"), text("terms are not compatible with lattice " + (pretty12(v) + (": " + (pretty22(v1) + (", " + pretty22(v2))))))]);
        };
      };
    };
  };
  var fromRelGetLat = function(dictMonadAff) {
    ...
    return function(v) {
      return bind7(ask3)(function(v1) {
        return maybe(throwError4([text("fromRelGetLat"), text("unknown relation name: " + pretty3(v))]))(pure17)(lookup7(v)(v1.relLats));
      });
    };
  };
  var latCompare_Prop = function(dictMonadAff) {
    ...
    return function(v) {
      return function(v1) {
        var $498 = notEq1(v.value0)(v1.value0);
        if ($498) {
          return pure17(new Tuple(empty9, Nothing.value));
        }
        ;
        return bind7(fromRelGetLat1(v.value0))(function(l) {
          return bind7(runWriterT(latCompare_Term1(l)(v.value1)(v1.value1)))(function(v2) {
            return bind7(runMaybeT(solveSysForSubst1(v2.value1)))(function(v3) {
              if (v3 instanceof Nothing) {
                return pure17(new Tuple(empty9, Nothing.value));
              }
              ;
              if (v3 instanceof Just) {
                return pure17(new Tuple(v3.value0, v2.value0));
              }
              ;
              throw new Error("Failed pattern match at Foliage.Engine (line 250, column 42 - line 252, column 39): " + [v3.constructor.name]);
            });
          });
        });
      };
  ...
  var insertProp = function(dictMonadAff) {
    ...
    var pure17 = pure(applicativeReaderT(applicativeStateT(monadExceptT2)));
    var map29 = map(functorReaderT(functorStateT(functorExceptT(Monad0.Bind1().Apply0().Functor0()))));
    return function(p2) {
      return function(props) {
        var go2 = flip(foldM1)(new Tuple(true, none3))(function(v) {
          return function(q2) {
            return bind7(latCompare_Prop1(p2)(q2))(function(v1) {
              if (v1.value1 instanceof Nothing) {
                return pure17(new Tuple(v.value0, new Cons(q2, v.value1)));
              }
              ;
              if (v1.value1 instanceof Just && v1.value1.value0 instanceof LT) {
                return pure17(new Tuple(false, new Cons(q2, v.value1)));
              }
              ;
              ...
              if (v1.value1 instanceof Just && v1.value1.value0 instanceof GT) {
                return pure17(new Tuple(v.value0, v.value1));
              }
              ;
              throw new Error("Failed pattern match at Foliage.Engine (line 182, column 31 - line 186, column 43): " + [v1.constructor.name]);
            });
          };
        })(props);
    ...
    return function(v) {
      return discard14(lift43(trace1(text("applyRule " + pretty32(v)))))(function() {
        if (v.hyps instanceof Nil) {
          return pure17(singleton10(v.prop));
        }
        ;
        if (v.hyps instanceof Cons && v.hyps.value0 instanceof PropHyp) {
          return bind7(ask3)(function(props) {
            return map29(fold2)(traverse22(function(prop8) {
              return bind7(lift43(runMaybeT(unify1(v.hyps.value0.value0)(prop8))))(function(v1) {
                if (v1 instanceof Nothing) {
                  return discard14(lift43(trace1(text("\u2717 " + pretty42(v.hyps.value0.value0)))))(function() {
                    return pure17(none3);
                  });
                }
                ;
                ...
                ;
                throw new Error("Failed pattern match at Foliage.Engine (line 146, column 47 - line 156, column 30): " + [v1.constructor.name]);
              });
            })(props));
          });
        }
        ...
        if (v.hyps instanceof Cons && v.hyps.value0 instanceof CompHyp) {
          return bind7(lift43(runComp1(v.hyps.value0.value1)))(function(a2) {
            return bind7(lift43(flip(runReaderT)({
              sigma: singleton4(v.hyps.value0.value0)(a2)
            })(subst_Rule1({
              prop: v.prop,
              hyps: v.hyps.value1
            }))))(function(rule$prime) {
        ...
        ;
        throw new Error("Failed pattern match at Foliage.Engine (line 138, column 3 - line 164, column 44): " + [v.hyps.constructor.name]);
      });
    };
  };
  var loop = function(dictMonadAff) {
    ...
    var lift53 = lift12(monadExceptT2);
    var lift62 = lift22(Monad0);
    return bind7(ask(monadAskReaderT(monadStateT2)))(function(ctx) {
      return bind7(get4)(function(env) {
        return discard14(trace1(text("loop where gas = " + pretty52(env.gas))))(function() {
          return discard14(when4(env.gas <= 0)(throwError4([div2([])([text("out of gas")]), div2([])([text("sample text")])])))(function() {
            return bind7(map29(fold2)(traverse22(function(v) {
              ...
              return discard14(trace1(text("new_props = " + pretty62(v))))(function() {
                return bind7(flip(foldM1)(new Tuple(false, env.props))(function(v1) {
                  return function(p2) {
                    return bind7(insertProp1(p2)(v1.value1))(function(v2) {
                      return discard14(trace1(text("insertProp " + (parens(pretty42(p2)) + (" " + (parens(pretty62(v1.value1)) + (" -> " + parens(pretty72(new Tuple(v2.value0, v2.value1))))))))))(function() {
                        return pure17(new Tuple(v1.value0 || v2.value0, v2.value1));
                      });
                    });
                  };
                })(v))(function(v1) {
                      ...
                      return discard14(set_props1(v1.value1))(function() {
                        return discard14(modify_5(function(v2) {
                          ...
                          return discard14(liftAff2(delay(ctx.delay_duration)))(function() {
                            return discard14(whenM2(lift43(lift53(lift62(ctx.stopped))))(throwError4([text("stopped")])))(function() {
  ...
  var main2 = function(dictMonadAff) {
    var Monad0 = dictMonadAff.MonadEffect0().Monad0();
    var bind7 = bind(bindExceptT(Monad0));
    ...
    var pure17 = pure(applicativeExceptT(Monad0));
    return function(args) {
      var v = defs_of_Prog(args.prog);
      return bind7(flip(execStateT2)({
  ...
  var pretty10 = /* @__PURE__ */ pretty(prettyName);
  var map19 = /* @__PURE__ */ map(/* @__PURE__ */ functorReaderT(functorIdentity));
  ...
  var stmt_template = function(v) {
    return pure9(div2([css(discard4(tell3(["border-radius: 1em", "border-left: 0.2em solid black"]))(function() {
      return tell3(["display: flex", "flex-direction: column", "gap: 0.5em", "padding: 0.5em"]);
    }))])(fold3([[v.label], maybe(none4)(function(body$prime) {
      return [div2([css(tell3(["margin-left: 1em"]))])([body$prime])];
    })(v.body)])));
  };
  var punc = function(s) {
    return pure9([div2([css(tell3(["color: black"]))])([text(s)])]);
  };
  var name3 = function(x) {
    return pure9([div2([css(tell3(["color: blue"]))])([text(pretty10(x))])]);
  };
  var rel = function(v) {
    return name3(v);
  };
  var line = function(xs) {
    return pure9(div2([css(tell3(["display: flex", "flex-direction: row", "gap: 0.5em"]))])(xs));
  };
  var kw = function(s) {
    return pure9([div2([css(tell3(["color: green"]))])([text(s)])]);
  };
  var lat = function(v) {
    if (v instanceof UnitLat) {
      return kw("Unit");
    ...
    ;
    if (v instanceof DiscreteLat) {
      return map19(fold3)(sequence2([kw("Discrete"), punc("("), lat(v.value0), punc(")")]));
    }
    ;
    if (v instanceof OppositeLat) {
      return map19(fold3)(sequence2([kw("Opposite"), punc("("), lat(v.value0), punc(")")]));
    }
    ;
  ...
  var term = function(v) {
    ...
    ;
    if (v instanceof PairTerm) {
      return map19(fold3)(sequence2([punc("("), term(v.value0), punc(" , "), term(v.value1), punc(")")]));
    }
    ;
    throw new Error("Failed pattern match at Foliage.Ui.Grammar (line 123, column 1 - line 123, column 60): " + [v.constructor.name]);
  };
  var prop7 = function(v) {
    return map19(fold3)(sequence2([rel(v.value0), punc("("), term(v.value1), punc(")")]));
  };
  var typ = function(v) {
    ...
    if (v instanceof ProdTyp) {
      return map19(fold3)(sequence2([punc("("), typ(v.value0), kw("\xD7"), typ(v.value1), punc(")")]));
    }
    ;
    throw new Error("Failed pattern match at Foliage.Ui.Grammar (line 67, column 1 - line 67, column 58): " + [v.constructor.name]);
  };
  var comp = function(v) {
    return map19(fold3)(sequence2([name3(v.value0), punc("("), intercalate12(punc(","))(map110(term)(v.value1)), punc(")")]));
  };
  var hyp = function(v) {
    if (v instanceof PropHyp) {
    ...
    ;
    if (v instanceof CompHyp) {
      return map19(fold3)(sequence2([name3(v.value0), punc("\u2190"), comp(v.value1)]));
    }
    ;
    if (v instanceof CondHyp) {
      return map19(fold3)(sequence2([punc("if"), term(v.value0)]));
    }
    ;
    throw new Error("Failed pattern match at Foliage.Ui.Grammar (line 102, column 1 - line 102, column 58): " + [v.constructor.name]);
  };
  var rule = function(v) {
    return map19(div2([css(tell3(["display: flex", "flex-direction: column", "gap: 0.5em"]))]))(map19(fold3)(sequence2([foldMap13(function(h) {
      return sequence2([bind3(hyp(h))(line)]);
    })(v.hyps), pure9([div2([css(tell3(["height: 0.1em", "background-color: black"]))])([])]), sequence2([bind3(prop7(v.prop))(line)])])));
  };
  var stmt = function(v) {
    if (v instanceof DefRel) {
      return bind3(ask2)(function(ctx) {
        return bind3(bind$prime2(line)(map19(fold3)(sequence2([punc("relation"), name3(v.value0), punc("("), lat(v.value1), punc(")")]))))(function(label5) {
          return bind3(function() {
            var m_props = foldMap22(function(v1) {
              if (eq4(v.value0)(v1.value0)) {
                return [map19(li([]))(sequence2([bind3(prop7(v1))(line)]))];
              }
              ;
              return [];
            })(ctx.props);
            var $89 = $$null5(m_props);
            if ($89) {
              return pure9(none1);
            }
            ;
            return bind3(sequence2(m_props))(function(props) {
              return map19(map22(pure1)(div2([css(tell3(["display: flex", "flex-direction: column", "gap: 0.5em"]))])))(map19(fold3)(sequence2([punc("known instances:"), pure9([ul([])(props)])])));
            });
          }())(function(body2) {
    ...
    if (v instanceof DefRule) {
      return bind3(bind$prime2(line)(map19(fold3)(sequence2([punc("rule"), name3(v.value0)]))))(function(label5) {
        return bind3(rule(v.value1))(function(body2) {
          return stmt_template({
            label: label5,
            body: pure1(body2)
          });
    ...
    if (v instanceof DefFun) {
      var params = map19(fold3)(sequence2(intercalate22([punc(",")])(map110(function(v1) {
        return [name3(v1.value0), punc(":"), typ(v1.value1)];
      })(v.value1))));
      return bind3(bind$prime2(line)(map19(fold3)(sequence2([punc("fun"), name3(v.value0), punc("("), params, punc(")"), punc("\u2192"), typ(v.value2), punc(":="), punc("<fun>")]))))(function(label5) {
        return stmt_template({
          label: label5,
          body: none1
        });
    ...
    ;
    throw new Error("Failed pattern match at Foliage.Ui.Grammar (line 35, column 1 - line 35, column 52): " + [v.constructor.name]);
  };
  var prog2 = function(v) {
    return map19(div2([css(discard4(tell3(["gap: 0.5em"]))(function() {
      return tell3(["display: flex", "flex-direction: column", "width: 100%"]);
    }))]))(map19(fromFoldable7)(traverse3(stmt)(v)));
  };
  ...
  var component2 = function(dictMonadAff) {
    ...
    var render = function(state3) {
      ...
      return div3([css(discard12(tell4(["flex-grow: 1", "flex-shrink: 1"]))(function() {
      ...
      }))])([new Tuple("title", div2([css(tell4(["padding: 0.5em", "background-color: black", "color: white"]))])([text("program")])), new Tuple("controls", match3({
        ready: $$const(div2([css(tell4(["padding: 0.5em", "display: flex", "flex-direction: row", "gap: 1em"]))])(fold4([[div2([])([button([onClick($$const(inj12(unit))), css(tell4(["flex-grow: 0", "flex-shrink: 0"]))])([text("fixpoint")])])], maybe([])(function(result) {
          return [div2([css(tell4(["flex-grow: 1", "flex-shrink: 1"]))])(map20(fromPlainHTML)(result))];
        })(state3.result)]))),
        running: $$const(div2([css(tell4(["padding: 0.5em", "display: flex", "flex-direction: row", "gap: 0.5em"]))])([div2([])([text("running...")]), div2([])([button([onClick($$const(inj22(unit)))])([text("stop")])])]))
        ...
        return inj32(fromRight$prime(impossible)(fromJsonString2(s)));
      }), value3(toJsonString2(state3.initial_gas))])(map20(function(v) {
        ...
        return inj42(fromRight$prime(impossible)(fromJsonString1(s)));
      }), value3(toJsonString1(unwrap5(state3.delay_duration)))])(map20(function(v) {
    ...
    var handleAction = match3({
            ...
            return bind4(runExceptT(main4({
              ...
              if (result instanceof Left) {
                return discard23(modify_4(function(v1) {
                  ...
                  ;
                  $65.status = inj5(unit);
                  $65.result = pure10(result.value0);
                  return $65;
                }))(function() {
              ...
              if (result instanceof Right) {
                return modify_4(function(v1) {
                  ...
                  ;
                  $69.status = inj5(unit);
                  $69.result = pure10([text("success")]);
                  $69.props = result.value0.props;
                  return $69;
                });
              }
              ;
              throw new Error("Failed pattern match at Foliage.Ui.Program (line 86, column 9 - line 103, column 16): " + [result.constructor.name]);
            });
          });
        });
      },
      ...
      set_delay_duration: function(delay_duration) {
        return modify_4(function(v) {
          ...
          ;
          $77.delay_duration = wrap2(delay_duration);
          return $77;
        });
      },
  ...
  var selectElement = function(query3) {
    return bind5(liftEffect3(bindFlipped4(composeKleisliFlipped4(function() {
  ...
  var insert9 = /* @__PURE__ */ insert2(ordSubscriptionId);
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect4(read(ref2)))(function(v2) {
                    return discard13(liftEffect4(modify_(map25(insert9(sid)(finalize)))(v2.subscriptions)))(function() {
          ...
          return function(preInits) {
            return unDriverStateX(function(st) {
              ...
              return modify_(function(handlers) {
                return {
                  initializers: new Cons(discard24(parSequence_3(reverse(handlers.initializers)))(function() {

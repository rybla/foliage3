...
(() => {
  ...
  var component = function(dictMonadAff) {
    var render = function(state3) {
      return div2([css(discard1(tell2(["flex-grow: 0", "flex-shrink: 1", "width: 400px"]))(function() {
        ...
        return function(html2) {
          return [new Tuple(show2(i2), div2([css(tell2(["padding: 0.5em", "box-shadow: 0 0 0 1px black inset"]))])([fromPlainHTML(html2)]))];
        };
      })(state3.messages))]);
    };
  ...
  var component2 = function(dictMonadAff) {
    var render = function(state3) {
      return div2([css(discard12(tell3(["flex-grow: 1", "flex-shrink: 1"]))(function() {
        return tell3(["padding: 0.5em"]);
      }))])([div2([css(tell3(["padding: 0.5em", "background-color: black", "color: white"]))])([text("program")]), div2([])([text(show3(state3.counter))]), button([onClick($$const(new Raise2(text("test message #" + show3(state3.counter)))))])([text("raise message")])]);
    };
    var initialState = function(v) {
      return {
        counter: 0
    ...
    var handleAction = function(v) {
      return discard23(addModifying2(prop5($$Proxy.value)(strongFn))(1))(function() {
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect4(read(ref2)))(function(v2) {
                    return discard13(liftEffect4(modify_(map22(insert4(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var component3 = function(dictMonadAff) {
    ...
    var render = function(v) {
      return div2([css(tell5(["display: flex", "flex-direction: row", "height: 100vh", "width: 100vw"]))])([slot1($$Proxy.value)(unit)(component1)({})(MessageAction.create), slot22($$Proxy.value)(unit)(component22)({})(absurd)]);
    };
    var initialState = function(v) {
      return {};
    };
